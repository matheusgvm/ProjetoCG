...
void parametrosIniciais(){//define parâmetros iniciais do jogo
  ...
  BlackHole.x = 0;
  BlackHole.y = 0;
  BlackHole.largura = 100;
  BlackHole.altura = 100;
  GameOver.x = 30;
  GameOver.y = 30;
  GameOver.altura = 40;
  GameOver.largura = 40;
...
void obstaculo2(){
  ...
  for(int posicao=0; posicao<20; posicao++){
    Obstaculo[posicao].x = rand()%101;
    Obstaculo[posicao].y = rand()%71;
    Obstaculo[posicao].largura = 6;
    Obstaculo[posicao].altura = 6;
  }
}
...
void desenhaCena(void){
  ...
  if(score <= 0){ //game over
    jogando = 0;
    colocarTextura(BlackHole, blackhole);
...
void inicializa(void){
  ...
  carregaTextura(&blackhole, "black.png");
  carregaTextura(&gameover, "gameover1.png");
